...
import {X,Heart,Loader,MessageCircle} from 'lucide-react' 
...
return (
  <>
  <div className={`fixed inset-y-0 left-0 z-10 w-64 bg-white shadow-md overflow-hidden transition-transform duration-300
    ease-in-out
    ...
    <div className='flex flex-col h-full'>
      ...
      <h2 className='text-x1 font-bold text-pink-600'>Matches</h2>
...
<div className='flex flex-col items-center justify-center h-full text-center'>
  ...
  <p className='text-gray-500 max-w-xs'>
    Dont worry! Your perfect match is just around the corner. Keep swiping!
  </p>
</div>
);
const LoadingState=()=>(
<div className='flex flex-col items-center justify-center h-full text-center'>
  ...
  <p>We are finding your perfect macthes.This might take a moment...</p>
</div>
)
